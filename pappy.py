...
def infer_real_or_synthetic(analysis):
    ...
    if score >= 2:
        ...
        conclusion = "Overall Conclusion: Dataset is **uncertain/mixed**."
...
if real_file and synthetic_file:
    ...
    # Preview
    elements.append(Paragraph("Numeric Columns Preview", styles["Heading2"]))
    elements.append(Paragraph("<b>Real Dataset Preview</b>", styles["Heading3"]))
    elements.append(df_to_table(numeric_real))
    elements.append(Spacer(1, 10))
    elements.append(Paragraph("<b>Synthetic Dataset Preview</b>", styles["Heading3"]))
    elements.append(df_to_table(numeric_synth))
    elements.append(Spacer(1, 20))
